  ...
  <main class="container mx-auto px-6 py-12">
    ...
    <article class="max-w-4xl mx-auto">
      <header class="mb-12" in:fade={{ duration: 800, delay: 200 }}>
        ...
        <h1
          class="text-3xl md:text-5xl font-bold mb-6 leading-tight bg-gradient-to-r from-white via-purple-200 to-purple-400 bg-clip-text text-transparent"
        >
          {post.metadata.title}
        </h1>
      ...
      <!-- Article Content -->
      <div
        class="prose prose-invert prose-lg max-w-none prose-headings:text-white prose-p:text-gray-300 prose-a:text-purple-300 prose-strong:text-white prose-code:text-purple-300 prose-pre:bg-slate-800 prose-pre:border prose-pre:border-white/20"
